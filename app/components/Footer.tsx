    ...
    >
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 mb-6 sm:mb-8">
          <div>
            <h5 className="text-[color:var(--foreground)] font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Quick Links</h5>
            <ul className="space-y-1 sm:space-y-2 text-[color:var(--foreground)]/65 text-xs sm:text-sm">
              <li>
                <a href="/" className="underline underline-offset-2 decoration-[#020A16] hover:opacity-90 transition-opacity">
                  Home
                </a>
              </li>
              <li>
          ...
          <div>
            <h5 className="text-[color:var(--foreground)] font-semibold mb-2 sm:mb-3 text-sm sm:text-base">Legal</h5>
            <ul className="space-y-1 sm:space-y-2 text-[color:var(--foreground)]/65 text-xs sm:text-sm">
              <li>
                <a href="/privacy" className="underline underline-offset-2 decoration-[#020A16] hover:opacity-90 transition-opacity">
                  Privacy
                </a>
              </li>
              <li>
                <a href="/terms" className="underline underline-offset-2 decoration-[#020A16] hover:opacity-90 transition-opacity">
                  Terms
                </a>
              </li>
              <li>
                <a href="#about" className="underline underline-offset-2 decoration-[#020A16] hover:opacity-90 transition-opacity">
                  About Us
                </a>
              </li>
            </ul>
